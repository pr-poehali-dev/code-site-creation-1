      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg leading-relaxed max-w-2xl mx-auto mb-12"
            style={{ color: "#c8bca8", fontFamily: "'Cormorant', serif", fontSize: "1.15rem" }}>Иней и Магма corp: Холистический центр интегративного здоровья. Собираем для вас персональный маршрут — где каждая процедура усиливает следующую.
 синтез передовых технологий и традиционных практик для целостного оздоровления.

Что объединяет проект:

инновации биохакинга и регенеративные технологии;

MedTech‑решения и комплексные чек‑апы;

велнес и соматические практики;

антистресс‑программы и детокс;

интеграция восточной медицины;

аюрведические программы очищения;

использование целебных минеральных вод;

пептидная терапия и anti‑age подходы;

принципы натуропатии;

биопитание и нутрициология.</p>
