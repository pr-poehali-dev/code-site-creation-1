    ...
    days: [
      ...
      },
      {
        ...
        blocks: [
          ...
          {
            time: "День 28 · финальный образ",
            icon: "✦",
            items: [
              "Финальная диагностика: сравнение всех показателей с Днём 1",
              "Профессиональная фотосессия — до и после",
              "Вечер у костра: рассказ каждого участника о трансформации",
              "Торжественный ужин: живая музыка, фермерская еда, благодарности",
            ],
          },
        ],
      },
