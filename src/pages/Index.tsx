        ...
        <div className="relative max-w-5xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center w-full">
          <div>
            <div className="mt-8">
              ...
              <p className="text-base leading-relaxed mb-6" style={{ color: "var(--eth-smoke)", fontFamily: "'Cormorant', serif", fontSize: "1.1rem" }}>Синтез древних традиций и инноваций
Мы создаём решения в области регенеративной медицины, опираясь на два столпа
- Проверенные веками практики оздоровления и восстановления.
- Современные «чит‑коды» биохакинга.
Проект в основе которого лежит алхимия. Процесс объединяющий противоположности: обжигающую магму, рвущуюся из глубин земли, и хрустальный иней, сотканный из дыхания зимы, их синергия создает Целебный Пар.. Благодаря которому мы запускаем процесс регенерации:</p>
      ...
      <section id="programs" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.4em] mb-4" style={{ color: "var(--eth-stone)" }}>банные ритуалы</p>
            <h2 className="text-5xl md:text-6xl font-light" style={{ fontFamily: "'Cormorant', serif", color: "var(--eth-gold2)" }}>Программы</h2>
