...
const programs = [
  {
    ...
    tagline: "Женская программа · 3 часа",
    description: "Нежный ритуал для тех, кто хочет ощутить себя любимой. Авторское обёртывание с медитацией колокольчиками, очищение рукавицей кесе или берёзовым веником — лёгкость в теле, свобода в мыслях.",
    effect: "Очищение кожи · Обёртывание · Медитация колокольчиками",
    procedures: [
    ...
    extra: "",
    guests: "женская программа",
    duration: "3 часа",
    price: "от 12 000 ₽",
    color: "#e8d5c0",
    dimColor: "rgba(232,213,192,0.08)",
  },
  {
    id: "rodnik",
    symbol: "🍊",
    title: "Терпкий родник",
    tagline: "Мужская программа · 3 часа",
    description: "Яркая перезагрузка для мужчин. Кислотный пилинг стоп, глубокое парение с пеленанием на качелях под колокольчики, солевое выкатывание с ледяным грейпфрутом. Обновление done ✓",
    effect: "Кислотный пилинг · Пеленание на качелях · Детокс",
    procedures: [
      "Знакомство с банькой",
      "Проливка ножек, нанесение кислотного пилинга на стопы, церемония первого пара, арома‑терапия",
      ...
      "Время, чтобы глубоко выдохнуть, вдохнуть и снова выдохнуть, от вашей кожи идёт пар, и мы продолжаем",
      "Солевое выкатывание с контрастно‑минеральной проливкой и ледяным грейпфрутом по телу",
    ],
    extra: "",
    guests: "мужская программа",
    duration: "3 часа",
    price: "от 8 500 ₽",
    color: "#d4622a",
    dimColor: "rgba(212,98,42,0.08)",
  },
  {
    id: "tuman",
    symbol: "🌫",
    title: "Тайны тумана",
    tagline: "4–6 гостей · 4 часа",
    description: "Банька, купель и качели полностью в вашем распоряжении. Фруктовая нарезка, орешки и мёд, плед и чай — а в финале загадываем тайное желание на ковше и отправляем его через пар баньки.",
    effect: "Свобода выбора · Купель · Желание на ковше",
    procedures: [
      "Знакомство с банькой",
      "Проливка ножек, церемония первого пара",
      "Банька, купель и качели в вашем распоряжении — чаевничайте, обернувшись в плед, пробуйте фруктовую нарезку, орешки и мёд",
      "Индивидуальная услуга на выбор: медовый скраб, омовение рукавицей кесе или солевое выкатывание",
      "Ледяные фруктовые контрасты — 500 ₽. Ооочень советуем!",
      "Загадываем на ковше тайное желание — отправляем через пар баньки к исполнению",
    ],
    extra: "Ледяные фруктовые контрасты — 500 ₽/гость",
    guests: "4–6 гостей",
    duration: "4 часа",
    price: "от 9 000 ₽/гость",
    color: "#6aaad0",
    dimColor: "rgba(106,170,208,0.08)",
  },
  {
    id: "les",
    symbol: "🌲",
    title: "Вглубь лесных троп",
    tagline: "2 гостя · 4 часа",
    description: "Самое глубокое путешествие в себя. Бесконтактный прогрев, дубовые веники с грейпфрутами, пеленание на качелях со звуковой медитацией, медово‑травяной скраб и видовая площадка с ореховой маской.",
    effect: "Бесконтактный прогрев · Пеленание · Медово‑травяной скраб",
    procedures: [
      "Проливка ножек, церемония первого пара, арома‑терапия",
      "Время чая или авторского лимонада, тишина или приятное общение — наслаждайтесь облаками и шелестом деревьев",
      "Бесконтактный прогрев",
      "Классическое парение с дубовыми вениками и ароматными грейпфрутами",
      "Время холодной купели и пледа, пеленание на качелях и звуковая медитация",
      "Нежнейшее медово‑травяное скрабирование",
      "Выход на видовую площадку: ореховая маска на волосы, молочная ванночка с клюквой для ног",
    ],
  ...
  },
  {
    id: "svezhest",
    symbol: "🌿",
    title: "Свежесть полей",
    tagline: "2 гостя · 3 часа",
    description: "Мягкая перезагрузка с ароматом трав и медовым прикосновением. Холодный хвойный домик из веников, пеленание на качелях со звуковой медитацией, скраб с ледяными ароматными шариками.",
    effect: "Хвойный дом · Пеленание · Ледяные шарики",
    procedures: [
      "Знакомство с банькой",
      "Проливка ножек, церемония первого пара, арома‑терапия",
  ...
  },
  {
    ...
    symbol: "ᛟ",
    title: "Шёпот предков",
    tagline: "4–6 гостей · 3 часа",
    description: "Сила — в общем ритуале. Бесконтактный прогрев под этническое музыкальное сопровождение, банька и купель в своём ритме, завершение густым паром с ледяными шариками и звуковой медитацией.",
    effect: "Этническое сопровождение · Ледяные шарики · Звуковая медитация",
    procedures: [
      "Знакомство с банькой",
      "Проливка ножек, бесконтактный прогрев под этническое музыкальное сопровождение и ароматы трав",
      "Банька, купель и качели в вашем распоряжении — чай, плед, фруктовая нарезка и мёд, всё по вашему желанию",
      "Завершение программы: густой пар с ледяными шариками для самообтирания и звуковая медитация",
    ],
    extra: "",
    guests: "4–6 гостей",
    duration: "3 часа",
    ...
    color: "#9b7fb5",
    dimColor: "rgba(155,127,181,0.08)",
  },
];
...
const SYSTEM_PROMPT = `Ты — помощник проекта «Иней & Магма corp.». Отвечай тепло, поэтично, кратко (2-4 предложения). Проект ведёт авторские банные программы в Краснодаре — пространство «Рябина & Дым Lounge».

Программы Рябина & Дым (с пармастером):
— «Молочные берега» (женская) — 3 ч, от 12 000 ₽ (будни) / 14 500 ₽ (вечер/вых): знакомство с банькой, пар, девичьи секреты, обёртывание с медитацией колокольчиками.
— «Терпкий родник» (мужская) — 3 ч, от 8 500 ₽ / 10 500 ₽: кислотный пилинг стоп, глубокое парение с пеленанием на качелях, солевое выкатывание с ледяным грейпфрутом.
— «Тайны тумана» — 4 ч, от 9 000 ₽/гость (4–6 чел.): банька/купель/качели на выбор, индивидуальная услуга, желание на ковше.
— «Вглубь лесных троп» — 4 ч, от 29 000 ₽ / 32 000 ₽ (2 гостя): бесконтактный прогрев, дубовые веники, пеленание, медово-травяной скраб, видовая площадка.
— «Свежесть полей» — 3 ч, от 21 000 ₽ / 23 000 ₽ (2 гостя): хвойный дом из веников, пеленание со звуковой медитацией, скраб с ледяными шариками.
— «Шёпот предков» — 3 ч, от 6 500 ₽/гость (4–6 чел.): этническое сопровождение, ледяные шарики, звуковая медитация.
— «Арбузный лимонад» — 3–4 ч, 24 000–38 000 ₽: арбуз + цитрус, парение, пилинг, арбузное масло.
— «Морозный кокос» (TOP) — 3–4 ч, 35 000–40 000 ₽ (1–2 гостя): кокос+манго, бамбуковые палочки, кокосовое обёртывание.
— «Eucalyptus Stone Therapy» — 2–3 ч, 26 000–32 000 ₽ (1–2 гостя): эвкалипт, купель с пихтой, стоун-терапия.
— «Рахат‑лукум» — 2–4 ч, 12 500–16 000 ₽: пилинг кесе, шоколадное обёртывание, масло сандала.
— «Тыквенное золото» — 2–4 ч, 25 000–32 000 ₽: тыква+корица, маска с куркумой, тыквенный латте.
— «Клубничное мохито» — 3–4 ч, 22 000–28 000 ₽: огуречные компрессы, клубничная маска, мохито.
— «Ромашковое поле» (семейная) — 3 ч, 18 000–23 000 ₽: дети + взрослые, пикник, фото +4 000 ₽.
— Баня без пармастера — аренда 5 900 ₽/час, минимум 3 часа.

Запись: форма на сайте или написать в Max. Халаты, тапочки, шапки, полотенца — предоставляются. Пеленание на качелях со звуковой медитацией — +3 500 ₽/гость. Отвечай только на вопросы о бане и программах.`;

const FAQ_QUICK = [
  { label: "Цены?", answer: "Молочные берега — от 12 000 ₽, Терпкий родник — от 8 500 ₽, Свежесть полей — от 21 000 ₽, Вглубь лесных троп — от 29 000 ₽, Морозный кокос (TOP) — от 35 000 ₽. Баня без пармастера — 5 900 ₽/час." },
  ...
  { label: "Соло или группой?", answer: "Посещение доступно соло или группой. Программы рассчитаны на 1–6 гостей в зависимости от выбора. Пространство полностью ваше." },
  { label: "Подарочный сертификат?", answer: "Да! Оформляем красивые сертификаты на любую из 13 программ или произвольную сумму. Выберите на странице «Сертификат» 🎁" },
  { label: "Как записаться?", answer: "Заполните форму на сайте или напишите в Max. Подберём удобное время вместе 🌿" },
];
...
function Chatbot() {
  ...
  async function send() {
    ...
    setMessages(p => [...p, {
      from: "bot",
      text: result.success && result.content ? result.content : "Лучше уточните у нас напрямую — напишите в Max, и мы подберём программу под вас 🌿",
    }]);
  }
      ...
      {open && (
        <div className="fixed bottom-24 right-6 z-50 w-80 rounded-2xl shadow-2xl overflow-hidden animate-slide-up"
          ...
          <div className="px-4 py-3 flex items-center gap-3"
            ...
            <div>
              <p className="text-sm font-medium" style={{ fontFamily: "'Cormorant', serif", color: "var(--eth-gold2)" }}>Иней & Магма corp.</p>
              <p className="text-xs" style={{ color: "var(--eth-stone)" }}>всегда на связи</p>
            </div>
          </div>
          ...
          {status === "ok" ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--eth-stone)" }}>
                Мы свяжемся с вами и подберём программу со скидкой 15%.
              </p>
            </div>
          ) : (
            <>
