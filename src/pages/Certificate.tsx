...
const programCerts = [
  ...
  },
  {
    ...
    tagline: "3–4 ч · для всех",
    price: "от 24 000 ₽",
    guests: "для всех",
    color: "#e05a6a",
    glow: "rgba(224,90,106,0.2)",
    bg: "linear-gradient(135deg, #200a10, #1a1410)",
  },
  {
    id: "kokos",
    symbol: "🥥",
    name: "Морозный кокос",
    tagline: "3–4 ч · 1–2 гостя",
    price: "от 35 000 ₽",
    guests: "1–2 гостя",
    color: "#4ab8d8",
    glow: "rgba(74,184,216,0.2)",
    bg: "linear-gradient(135deg, #081620, #1a1410)",
  },
  {
    id: "stone",
    symbol: "🗿",
    name: "Eucalyptus Stone Therapy",
    tagline: "2–3 ч · 1–2 гостя",
    price: "от 26 000 ₽",
    guests: "1–2 гостя",
    color: "#7aab9e",
    glow: "rgba(122,171,158,0.2)",
  ...
  },
  {
    ...
    symbol: "🍮",
    name: "Рахат‑лукум",
    tagline: "2–4 ч · 1–3 гостя",
    price: "от 12 500 ₽",
    guests: "1–3 гостя",
    color: "#c8923a",
    glow: "rgba(200,146,58,0.2)",
    bg: "linear-gradient(135deg, #1c1208, #1a1410)",
  },
  {
    id: "tykva",
    symbol: "🎃",
    name: "Тыквенное золото",
    tagline: "2–4 ч · для всех",
    price: "от 25 000 ₽",
    guests: "для всех",
    color: "#e8922a",
    glow: "rgba(232,146,42,0.2)",
    bg: "linear-gradient(135deg, #1e1206, #1a1410)",
  },
  {
    id: "klubnika",
    symbol: "🍓",
    ...
    guests: "для всех",
    color: "#e05a80",
    glow: "rgba(224,90,128,0.2)",
    bg: "linear-gradient(135deg, #1e0810, #1a1410)",
  },
  {
    id: "romashka",
    symbol: "🌼",
    name: "Ромашковое поле",
    tagline: "3 часа · семейная",
    price: "от 18 000 ₽",
    guests: "семья с детьми",
    color: "#e8d86a",
    glow: "rgba(232,216,106,0.2)",
    bg: "linear-gradient(135deg, #1c1a06, #1a1410)",
  },
  {
    id: "banya",
    symbol: "🔑",
    name: "Баня без пармастера",
    tagline: "от 3 часов · аренда",
    price: "17 700 ₽ / 3 часа",
    guests: "до 4 человек",
    color: "#c8923a",
    glow: "rgba(200,146,58,0.2)",
...
const amountCerts = [
  { id: "a6500", amount: "6 500 ₽", desc: "Шёпот предков — будни до 18:00 · за гостя" },
  { id: "a8500", amount: "8 500 ₽", desc: "Терпкий родник — будни до 18:00 · 2 гостя" },
  { id: "a12000", amount: "12 000 ₽", desc: "Молочные берега — будни до 18:00 · 2 гостя" },
  { id: "a21000", amount: "21 000 ₽", desc: "Свежесть полей — будни до 18:00 · 2 гостя" },
  { id: "a29000", amount: "29 000 ₽", desc: "Вглубь лесных троп — будни до 18:00 · 2 гостя" },
  { id: "a17700", amount: "17 700 ₽", desc: "Баня без пармастера — 3 часа · до 4 гостей" },
  { id: "a35000", amount: "35 000 ₽", desc: "Морозный кокос — 3 часа · 1–2 гостя" },
