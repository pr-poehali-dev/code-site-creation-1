...
const banyaFaqData = [
  ...
  { q: "Соло или группой?", a: "Доступно соло, вдвоём, семьёй или компанией до 6 гостей — в зависимости от программы. Пространство полностью ваше — никто не входит без вашего разрешения." },
  { q: "Какие программы есть?", a: "14 программ на любой запрос:\n• Молочные берега (женская) — от 12 000 ₽\n• Терпкий родник (мужская) — от 8 500 ₽\n• Тайны тумана — от 9 000 ₽/гость\n• Вглубь лесных троп — от 29 000 ₽\n• Свежесть полей — от 21 000 ₽\n• Шёпот предков — от 6 500 ₽/гость\n• Арбузный лимонад — от 24 000 ₽\n• Морозный кокос (TOP) — от 35 000 ₽\n• Eucalyptus Stone Therapy — от 26 000 ₽\n• Рахат‑лукум — от 12 500 ₽\n• Тыквенное золото — от 25 000 ₽\n• Клубничное мохито — от 22 000 ₽\n• Ромашковое поле (семейная) — от 18 000 ₽\n• Баня без пармастера — 5 900 ₽/час (от 3 ч)" },
  ...
  { q: "Можно ли взять пармастера?", a: "Да! Большинство программ проводятся с пармастером — 1 или 2 мастера в зависимости от длительности. Пеленание на качелях со звуковой медитацией — +3 500 ₽/гость. Уточняйте при бронировании в Max." },
  { q: "Кому подойдёт?", a: "• Тем, кто чувствует эмоциональное выгорание и усталость\n• Семьям с детьми — программа «Ромашковое поле»\n• Мужским компаниям — «Терпкий родник»\n• Женским группам — «Молочные берега»\n• Ценящим традиции русской бани с авторским подходом" },
      ...
      <section className="py-20 px-6" style={{ background: "rgba(14,8,22,0.99)" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                symbol: "🥛", title: "Молочные берега", duration: "3 часа", guests: "женская",
                color: "#e8d5c0",
                procedures: [
                ...
                note: "Завершение: Лёгкость в теле, свобода в мыслях.",
                prices: [
              ...
              {
                symbol: "🍊", title: "Терпкий родник", duration: "3 часа", guests: "мужская",
                color: "#d4622a",
                procedures: [
                  "Знакомство с банькой",
                ...
                note: "Завершение: Обновление done ✓",
                prices: [
              ...
              },
              {
                ...
                procedures: [
                  ...
                  "Банька, купель и качели в вашем распоряжении — чаевничайте, обернувшись в плед, наблюдайте за природой, пробуйте свежую фруктовую нарезку, орешки и мёд, окунайтесь в холодную купель, всё по вашему желанию",
              ...
              },
              {
                ...
                procedures: [
                  "Проливка ножек, церемония первого пара, арома‑терапия",
                  "Время чая или авторского лимонада, тишина или приятное общение — наслаждайтесь облаками и шелестом деревьев, погружаясь всё глубже в расслабление…",
                  ...
                  "Выход на видовую площадку: нанесение ореховой маски на волосы, ножки в молочную ванночку с клюквой",
                ],
                note: "К завершению программы вы полностью обновлены — и мы будем рады видеть вас снова.",
                prices: [
