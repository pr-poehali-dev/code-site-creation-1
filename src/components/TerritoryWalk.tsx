...
const zones = [
  ...
  {
    id: "library", title: "Библиотека", subtitle: "Тишина · чтение · дневники", emoji: "📚", mapLabel: "БИБЛИОТЕКА",
    desc: "Уютные кабинеты с панорамными окнами в лес. Кресла у окна с видом на природу центра, письменные столы для дневников, коллекция книг по здоровью, осознанности и природе.",
    details: ["Личные кабинеты с видом на лес", "Коллекция книг центра", "Письмо дневников и заметок", "Тишина и наблюдение за природой"],
    image: "https://cdn.poehali.dev/projects/da18a679-098e-494d-8de1-a558d89808d6/files/554d67fb-1525-4cf0-8c9f-7d7dbcb1cb7c.jpg",
    color: "#7A6A4A", accent: "rgba(122,106,74,0.15)", icon: "🌿", mapX: 460, mapY: 435,
  },
];
